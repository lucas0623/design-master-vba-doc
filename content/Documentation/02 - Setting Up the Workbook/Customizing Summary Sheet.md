...
Hence, understanding the behaviour of these 2 processes will help you understanding how to building up the *Summary Sheet*. Also, it is important to understanding the [[../01 - Introduction/Tag System|Tag System]] that is used to locate the data for all processes in the add-in.
