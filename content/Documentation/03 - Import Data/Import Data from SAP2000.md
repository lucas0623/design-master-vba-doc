...
6. Click `OK` and the output table will be rendered. Then click `File > Export All Tables > To Excel`. Save the excel table that contains the selected output data in your designated location.![[../../../public/Z_System/Attachment/{BE6EB5C5-881A-4E69-9C6E-2B784BD1C03E}.png]]
